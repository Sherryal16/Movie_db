...
public class FavTvShow extends javax.swing.JFrame {
 ...
 void showFavTVShow()
 {
        ...
        String ans = movie_db_client.showFavTVShow();
        ...
        for (int i = 0; i < count; i++) {
            ...
            try {
                ...
                if (response.getStatus() == 200) {
                    ...
                    String ans1 = movie_db_client.checkButtontv(id);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                               YOUR FAVOURITE TVShows!!");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(93, 0, 510, 36);
        ...
        jScrollPane1.setBounds(37, 71, 566, 345);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FavTvShow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
